...
namespace FiscalLabService.Repository.PostgreSql.Migrations
{
    ...
    [Migration("20240126133044_AddVisit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FiscalLabService.Domain.Entities.Visit", b =>
                {
                    ...
                    b.Property<string>("LaboratoryLeader")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
            ...
            modelBuilder.Entity("FiscalLabService.Domain.Entities.Visit", b =>
                {
                    b.HasOne("FiscalLabService.Domain.Entities.Association", "Association")
                        .WithMany()
                        .HasForeignKey("AssociationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FiscalLabService.Domain.Entities.Plant", "Plant")
                        .WithMany()
                        .HasForeignKey("PlantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
